...
class __TwigTemplate_b2abd194453717be6cd42de0c4cf962c extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 27
            ((twig_get_attribute($this->env, $this->source, $context["user"], "registerDate", [], "any", false, false, false, 27)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "registerDate", [], "any", false, false, false, 27), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>";
            // line 28
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "urlPp", [], "any", false, false, false, 28), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 30
    ...
    <table class=\"table\">
        ...
        {% for user in users %}
            <tr>
                ...
                <td>{{ user.email }}</td>
                <td>{{ user.password }}</td>
                <td>{{ user.registerDate ? user.registerDate|date('Y-m-d') : '' }}</td>
                <td>{{ user.urlPp }}</td>
                <td>
...
{% endblock %}
", "user/index.html.twig", "C:\\Users\\User\\Desktop\\ETUDIANT\\chiirz\\chiirz\\templates\\user\\index.html.twig");
    }
}
